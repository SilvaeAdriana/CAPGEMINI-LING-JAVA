...
//realiza as transacoes/metodos conforme recebe os valores a partir de 'pessoa'
public class PessoaDao extends Dao {
	
	public void incluirPessoa(Pessoa p) throws Exception {//Pessoa p=objeto
		open();
		stmt = con.prepareStatement("insert into pessoa values(?,?,?)");//stmt=statement  , cada ? eh um campo da tabela
